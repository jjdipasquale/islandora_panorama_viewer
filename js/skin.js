...
// Generated Tue Feb 3 09:05:51 2015
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._up__img.setAttribute('src',basePath + 'skin/up.png');
		...
		this._up.onmouseover=function () {
			me._up__img.src=basePath + 'skin/up__o.png';
		}
		this._up.onmouseout=function () {
			me._up__img.src=basePath + 'skin/up.png';
		...
		this._down__img.setAttribute('src',basePath + 'skin/down.png');
		...
		this._down.onmouseover=function () {
			me._down__img.src=basePath + 'skin/down__o.png';
		}
		this._down.onmouseout=function () {
			me._down__img.src=basePath + 'skin/down.png';
		...
		this._left__img.setAttribute('src',basePath + 'skin/left.png');
		this._left__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;-webkit-user-drag:none;');
		this._left__img['ondragstart']=function() { return false; };
		this._left.appendChild(this._left__img);
		this._left.onmouseover=function () {
			me._left__img.src=basePath + 'skin/left__o.png';
		}
		this._left.onmouseout=function () {
			me._left__img.src=basePath + 'skin/left.png';
		...
		this._right__img.setAttribute('src',basePath + 'skin/right.png');
		this._right__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;-webkit-user-drag:none;');
		this._right__img['ondragstart']=function() { return false; };
		this._right.appendChild(this._right__img);
		this._right.onmouseover=function () {
			me._right__img.src=basePath + 'skin/right__o.png';
		}
		this._right.onmouseout=function () {
			me._right__img.src=basePath + 'skin/right.png';
		...
		this._zoomin__img.setAttribute('src',basePath + 'skin/zoomin.png');
		...
		this._zoomin.onmouseover=function () {
			...
			me._zoomin__img.src=basePath + 'skin/zoomin__o.png';
		}
		this._zoomin.onmouseout=function () {
			me._tt_zoomin.style[domTransition]='none';
			me._tt_zoomin.style.visibility='hidden';
			me._tt_zoomin.ggVisible=false;
			me._zoomin__img.src=basePath + 'skin/zoomin.png';
		...
		this._zoomout__img.setAttribute('src',basePath + 'skin/zoomout.png');
		...
		this._zoomout.onmouseover=function () {
			...
			me._zoomout__img.src=basePath + 'skin/zoomout__o.png';
		}
		this._zoomout.onmouseout=function () {
			me._tt_zoomout.style[domTransition]='none';
			me._tt_zoomout.style.visibility='hidden';
			me._tt_zoomout.ggVisible=false;
			me._zoomout__img.src=basePath + 'skin/zoomout.png';
		...
		this._autorotate__img.setAttribute('src',basePath + 'skin/autorotate.png');
		...
		this._autorotate.onmouseover=function () {
			...
			me._autorotate__img.src=basePath + 'skin/autorotate__o.png';
		}
		this._autorotate.onmouseout=function () {
			me._tt_autorotate.style[domTransition]='none';
			me._tt_autorotate.style.visibility='hidden';
			me._tt_autorotate.ggVisible=false;
			me._autorotate__img.src=basePath + 'skin/autorotate.png';
		}
		...
		this._info__img.setAttribute('src',basePath + 'skin/info.png');
		...
		this._info.onmouseover=function () {
			...
			me._info__img.src=basePath + 'skin/info__o.png';
		}
		this._info.onmouseout=function () {
			me._tt_info.style[domTransition]='none';
			me._tt_info.style.visibility='hidden';
			me._tt_info.ggVisible=false;
			me._info__img.src=basePath + 'skin/info.png';
		}
		...
		this._movemode__img.setAttribute('src',basePath + 'skin/movemode.png');
		...
		this._movemode.onmouseover=function () {
			...
			me._movemode__img.src=basePath + 'skin/movemode__o.png';
		}
		this._movemode.onmouseout=function () {
			me._tt_movemode.style[domTransition]='none';
			me._tt_movemode.style.visibility='hidden';
			me._tt_movemode.ggVisible=false;
			me._movemode__img.src=basePath + 'skin/movemode.png';
		}
		...
		this._fullscreen__img.setAttribute('src',basePath + 'skin/fullscreen.png');
		...
		this._fullscreen.onmouseover=function () {
			...
			me._fullscreen__img.src=basePath + 'skin/fullscreen__o.png';
		}
		this._fullscreen.onmouseout=function () {
			me._tt_fullscreen.style[domTransition]='none';
			me._tt_fullscreen.style.visibility='hidden';
			me._tt_fullscreen.ggVisible=false;
			me._fullscreen__img.src=basePath + 'skin/fullscreen.png';
		}
		...
		this._marker_active__img.setAttribute('src',basePath + 'skin/marker_active.png');
		...
		this._marker_normal__img.setAttribute('src',basePath + 'skin/marker_normal.png');
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		
		{
			...
			this._hsimage__img.setAttribute('src',basePath + 'skin/hsimage.png');
